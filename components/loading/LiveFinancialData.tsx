...
export function LiveFinancialData() {
  ...
  // Base prices memoizzati per evitare re-calcoli
  ...
  const cryptos = useMemo(() => ['BTC', 'ETH', 'ADA', 'DOT', 'SOL', 'AVAX'], []);
            ...
            >
              <div className="text-center">
                ...
                <div className="text-white text-xs font-mono leading-tight">
                  {item.symbol === 'BTC' ? `$${Math.round(item.price/1000)}k` : 
                   item.symbol === 'ETH' ? `$${Math.round(item.price)}` :
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-white text-sm font-mono">
                ${item.price.toFixed(item.symbol === 'BTC' ? 0 : 2)}
              </div>
