...
export const PORTFOLIO_DATA = [
  { name: 'USDC', value: 35, amount: '$12,456.78', color: '#2775CA' },
  { name: 'USDT', value: 25, amount: '$8,900.12', color: '#26A17B' },
  { name: 'UNI', value: 15, amount: '$5,340.45', color: '#FF007A' },
  { name: 'AAVE', value: 12, amount: '$4,270.67', color: '#B6509E' },
  { name: 'LINK', value: 8, amount: '$2,845.23', color: '#2A5ADA' },
  { name: 'COMP', value: 5, amount: '$1,778.90', color: '#00D395' }
] as const;
...
export const SITE_ASSETS = {
  ...
  logoImage: '/logo.png' // Fixed: replaced Figma asset with local logo
} as const;
