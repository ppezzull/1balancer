...
const convertPortfolioToShared = (portfolio: any): SharedPortfolio => {
  ...
  return {
    ...
    performance: {
      ...
      totalReturn: Number(portfolio.performance?.totalReturn || ((Number(portfolio.performance?.returnPercentage || portfolio.performance) || 0) / 100) * (Number(portfolio.totalValue || portfolio.totalInvestment) || 0)) || 0,
