...
export function DynamicBackground({ intensity = 1, responseToMouse = true }: BackgroundProps) {
  ...
  const activityDecayRef = useRef<ReturnType<typeof setTimeout> | null>(null);
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      >
        <motion.path
          fill={theme === "dark" ? "rgba(20, 184, 166, 0.3)" : "rgba(59, 130, 246, 0.25)"}
          animate={{
            d: [
        ...
        />
        <motion.path
          fill={theme === "dark" ? "rgba(34, 211, 238, 0.2)" : "rgba(14, 165, 233, 0.2)"}
          animate={{
            d: [
      ...
      {Array.from({ length: 50 }).map((_, i) => (
        <motion.div
          ...
          style={{
            width: theme === "dark" ? '4px' : '3px',
            height: theme === "dark" ? '4px' : '3px',
