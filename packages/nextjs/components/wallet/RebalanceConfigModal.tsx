...
import { Target, Clock, Activity, Check, Info } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
              selectedTemplate.strategy === 'endgame' ? 'bg-gradient-to-br from-yellow-400 to-orange-500' :
              selectedTemplate.strategy === 'gomora' ? 'bg-gradient-to-br from-red-400 to-pink-500' :
              selectedTemplate.strategy === 'tanos' ? 'bg-gradient-to-br from-purple-400 to-indigo-500' :
              selectedTemplate.strategy === 'realyield' ? 'bg-gradient-to-br from-green-400 to-emerald-500' :
              selectedTemplate.strategy === 'defi' ? 'bg-gradient-to-br from-blue-400 to-cyan-500' :
              selectedTemplate.strategy === 'meme' ? 'bg-gradient-to-br from-pink-400 to-rose-500' :
              selectedTemplate.strategy === 'ai' ? 'bg-gradient-to-br from-violet-400 to-purple-500' :
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <RadioGroup 
              value={rebalanceType} 
              onValueChange={(value) => setRebalanceType(value as 'drift' | 'time')}
              className="space-y-3"
            >
              {/* Drift-based */}
              <div className="flex items-start space-x-3 p-4 border border-border/30 rounded-lg hover:border-border/60 transition-colors">
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Label htmlFor="drift" className="font-medium">Drift-based Rebalancing</Label>
              ...
              <div className="flex items-start space-x-3 p-4 border border-border/30 rounded-lg hover:border-border/60 transition-colors">
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Label htmlFor="time" className="font-medium">Time-based Rebalancing</Label>
                  </div>
                  <p className="text-sm text-muted-foreground">
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={onSubmit} className="flex-1 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white">
