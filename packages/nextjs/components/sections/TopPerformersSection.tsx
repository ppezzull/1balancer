...
export function TopPerformersSection() {
  ...
  const categories = [
    ...
    { id: "institutional", label: "Institutional", count: communityPortfolios.filter(p => p.category === "institutional").length }
  ];
  ...
  return (
    <section 
      id="top-performers" 
      className="py-20 transition-colors duration-300 bg-background min-h-screen"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto transition-colors duration-300 leading-relaxed">
            Discover and learn from the most successful portfolio strategies shared by our community of expert traders and investors.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className={`flex ${isMobile ? 'flex-col space-y-4' : 'flex-row items-center justify-between'} gap-4 mb-6`}>
            {/* Search Bar */}
...
function PortfolioCard({ portfolio, index, onClick, isMobile, isDark }: PortfolioCardProps) {
            ...
            <div className="flex items-center justify-between">
              ...
              <div className={`flex items-center gap-1 ${
                ...
                <span className="font-bold text-sm">
                  {isPositiveReturn ? '+' : ''}{portfolio.performance.returnPercentage.toFixed(1)}%
                </span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-3">
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                className="p-1 h-auto hover:text-blue-500"
                onClick={handleShare}
              >
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                className="p-1 h-auto hover:text-yellow-500"
