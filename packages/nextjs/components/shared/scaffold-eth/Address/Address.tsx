...
// BlockieAvatar removed (RainbowKit not used)
...
export const Address = ({
  ...
  // BlockieAvatar removed, so ensAvatar is not needed

  // Helper to format address
  const shortAddress = checkSumAddress ? `${checkSumAddress.slice(0, 6)}...${checkSumAddress.slice(-4)}` : "";
  const displayAddress = format === "short" ? shortAddress : checkSumAddress;
