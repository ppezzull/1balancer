...
import { ArrowLeft, TrendingUp, TrendingDown, Settings, MoreHorizontal, Eye } from "lucide-react";
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-6 text-center">
            ...
            <div className="mb-4">
              ...
              <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-lg font-semibold ${
                isPositive 
            ...
            <div className="inline-flex items-center gap-2 bg-accent/50 px-4 py-2 rounded-full">
              <div className="w-6 h-6 rounded-full overflow-hidden bg-gradient-to-br from-teal-400 to-cyan-500 flex items-center justify-center">
                <img 
                  src={crypto.image} 
                  alt={crypto.name}
            ...
            <Card className="border border-border/30 bg-card/50 backdrop-blur-sm">
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Latest developments and market insights for {crypto.name}. 
                  Stay updated with real-time news and analysis.
                </p>
              </CardContent>
            </Card>
          </div>
