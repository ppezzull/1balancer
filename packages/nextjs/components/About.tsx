...
export function About({
  ...
  const { ref: featuresRef, isInView: featuresInView } =
    useInViewAnimation();
  const { ref: howItWorksRef, isInView: howItWorksInView } =
    useInViewAnimation();
  ...
  const handleOldLogic = () => {
    if (!isWalletConnected) {
      toast.error("Wallet Connection Required", {
        description:
          "Please connect your wallet first to start using 1Balancer",
        duration: 4000,
        action: {
          label: "Connect",
          onClick: () => {
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed transition-colors duration-300">
              The next-generation decentralized portfolio
              management platform that revolutionizes how you
              balance, track, and optimize your cryptocurrency
              investments.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed transition-colors duration-300">
              1Balancer democratizes sophisticated portfolio
              management strategies by providing
              institutional-grade tools in a user-friendly,
              decentralized platform. We believe everyone should
              have access to advanced portfolio optimization
              techniques that were once exclusive to
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto transition-colors duration-300">
              ...
              control over your cryptocurrency portfolio
            </p>
          </motion.div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                >
                  ...
                  />
                  <h3 className="text-xl mb-3 text-foreground transition-colors duration-300">
                    {feature.title}
                  </h3>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={
              howItWorksInView ? { opacity: 1, y: 0 } : {}
            }
            transition={{ duration: 0.8 }}
            className="text-center mb-16"
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto transition-colors duration-300">
              Get started with 1Balancer in four simple steps
              and take control of your portfolio
            </p>
          </motion.div>
          ...
          <div className="space-y-8">
            {workflowSteps.map((step, index) => (
              <motion.div
                ...
                animate={
                  howItWorksInView ? { opacity: 1, x: 0 } : {}
                }
                transition={{
                  duration: 0.8,
                  delay: index * 0.2,
                ...
                <div className="flex-1">
                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="text-2xl text-foreground transition-colors duration-300">
                        {step.title}
                      </h3>
                    </div>
                    <p className="text-muted-foreground leading-relaxed transition-colors duration-300">
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed transition-colors duration-300">
                1Balancer leverages cutting-edge blockchain
                technology, smart contracts, and cross-chain
                analytics to provide a seamless, secure, and
                highly efficient portfolio management
                experience. Our platform is designed to scale
                with the evolving DeFi ecosystem.
              </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto transition-colors duration-300">
              Join thousands of users who have already optimized
              their crypto portfolios with 1Balancer
            </p>
