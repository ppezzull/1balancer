...
export function SocialSection() {
  ...
  const renderPortfolioCard = (portfolio: SocialPortfolio) => {
    ...
    return (
      <motion.div key={portfolio.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full">
        <Card
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <div
                      className={`flex items-center gap-1 text-xs ${getLevelColor(portfolio.user.level || "Beginner")}`}
                    >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="space-y-1">
                    {portfolio.tokens &&
                      portfolio.tokens.slice(0, isMobile ? 3 : 4).map((token, index) => (
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className={`flex items-center gap-1 text-xs transition-colors ${
                      portfolio.isLiked ? "text-red-500 hover:text-red-600" : "text-muted-foreground hover:text-red-500"
                    }`}
                  >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Discover and share investment strategies with the community. Learn from top performers and connect with
            fellow investors.
          </p>
        </motion.div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">{selectedPortfolio.strategy}</p>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {selectedPortfolio.tokens &&
                            selectedPortfolio.tokens.map((token, index) => {
                              const cryptoData = CRYPTOCURRENCY_DATA.find(c => c.symbol === token.symbol);
                              return (
                                <div
                                  ...
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-xs text-muted-foreground">
                                        {cryptoData?.name || token.symbol || "Unknown Token"}
                                      </p>
                                    </div>
                                  </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                {selectedPortfolio.user.followers.toLocaleString()} followers
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              <Bookmark
                                className={`w-4 h-4 mr-1 ${selectedPortfolio.isBookmarked ? "fill-current" : ""}`}
                              />
